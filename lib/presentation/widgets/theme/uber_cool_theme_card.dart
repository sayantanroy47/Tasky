...
class _UberCoolThemeCardState extends State<UberCoolThemeCard> with SingleTickerProviderStateMixin {
  ...
  void _initializeAnimation() {
    ...
    _hoverAnimation =
        Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: _hoverController, curve: Curves.easeOut));
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: Stack(children: [
          // Base background with theme surface
          Container(
  ...
  Widget _buildCardContent(ThemeData theme, dynamic metadata, dynamic colors) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const SizedBox(height: 8), // Space for color strip
  ...
  Widget _buildSelectionIndicator() {
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: widget.theme.colors.primary, shape: BoxShape.circle, boxShadow: [
          BoxShadow(
