...
/// Smart repository provider
final projectSmartRepositoryProvider = Provider<ProjectSmartRepository>((ref) {
  // SharedPreferences would be injected here in a real implementation
  throw UnimplementedError('SharedPreferences injection needed');
});

/// Provider for SharedPreferences (would be properly injected)
final sharedPreferencesProvider = Provider<SharedPreferences>((ref) {
  throw UnimplementedError('SharedPreferences must be initialized and provided');
});

/// Actual smart repository implementation
final smartRepositoryProvider = Provider<ProjectSmartRepository>((ref) {
...
final aiProjectAnalysisServiceProvider = Provider<AIProjectAnalysisService>((ref) {
  // AI parser would need to be properly provided
  throw UnimplementedError('CompositeAITaskParser provider needed');
});
...
final smartNotificationServiceProvider = Provider<SmartNotificationService>((ref) {
  // Enhanced notification service would need to be provided
  throw UnimplementedError('EnhancedNotificationService provider needed');
});
...
final projectHealthProvider = FutureProvider.family<ProjectHealth?, String>((ref, projectId) async {
  final repository = ref.watch(smartRepositoryProvider);
...
final smartFeaturesNotifierProvider = StateNotifierProvider<SmartFeaturesNotifier, SmartFeaturesState>((ref) {
  final repository = ref.watch(smartRepositoryProvider);
